...
echo '"/var/jenkins_home/workspace/<your app>" directory),'
...
echo 'Now...'
echo 'Visit http://localhost:50000 to see your application in action.'
echo '(This is why you specified the "args ''-p 50000:9000''" parameter when you'
